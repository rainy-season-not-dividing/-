...
void CGameSettingDlg::DoDataExchange(CDataExchange *pDX)
{
    ...
    DDX_Control(pDX, IDC_EDIT_ROWS, m_editMapRows);
    DDX_Control(pDX, IDC_EDIT_COLS, m_editMapCols);
    DDX_Control(pDX, IDC_EDIT_PIC_COUNT, m_editPicCount);
    DDX_Control(pDX, IDC_COMBO_THEME, m_comboTheme);
}

BEGIN_MESSAGE_MAP(CGameSettingDlg, CDialogEx)
ON_BN_CLICKED(IDC_RADIO_BGM_ON, &CGameSettingDlg::OnBnClickedRadioBgmOn)
ON_BN_CLICKED(IDC_RADIO_BGM_OFF, &CGameSettingDlg::OnBnClickedRadioBgmOff)
ON_CBN_SELCHANGE(IDC_COMBO_THEME, &CGameSettingDlg::OnCbnSelchangeComboTheme)
ON_EN_CHANGE(IDC_EDIT_ROWS, &CGameSettingDlg::OnEnChangeEditRows)
ON_EN_CHANGE(IDC_EDIT_COLS, &CGameSettingDlg::OnEnChangeEditCols)
ON_EN_CHANGE(IDC_EDIT_PIC_COUNT, &CGameSettingDlg::OnEnChangeEditPicCount)
...
BOOL CGameSettingDlg::OnInitDialog()
{
    ...
    // 设置音乐开关
    CButton *pRadioOn = (CButton *)GetDlgItem(IDC_RADIO_BGM_ON);
    CButton *pRadioOff = (CButton *)GetDlgItem(IDC_RADIO_BGM_OFF);
...
void CGameSettingDlg::OnBnClickedOk()
{
    ...
    case 0: // 水果主题
        ...
        break;
    case 1: // 动物主题
        ParamSetting::BGPath = _T("theme/picture/animal_bg.bmp");
        ParamSetting::ElementPath = _T("theme/picture/animal_element.bmp");
        ParamSetting::MaskPath = _T("theme/picture/animal_mask.bmp");
        ParamSetting::ClickSoundPath = _T("theme/sound/animal_click.wav");
        ParamSetting::ClearSoundPath = _T("theme/sound/animal_clear.wav");
        break;
    case 2: // 卡通主题
        ParamSetting::BGPath = _T("theme/picture/cartoon_bg.bmp");
        ParamSetting::ElementPath = _T("theme/picture/cartoon_element.bmp");
        ParamSetting::MaskPath = _T("theme/picture/cartoon_mask.bmp");
        ParamSetting::ClickSoundPath = _T("theme/sound/cartoon_click.wav");
        ParamSetting::ClearSoundPath = _T("theme/sound/cartoon_clear.wav");
        break;
    }
